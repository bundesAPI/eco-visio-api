...
from deutschland.EcoVisio import rest
from deutschland.EcoVisio.configuration import Configuration
from deutschland.EcoVisio.exceptions import ApiException, ApiTypeError, ApiValueError
from deutschland.EcoVisio.model_utils import (
    ModelComposed,
    ModelNormal,
    ModelSimple,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.zaehler  # this is an instance of the class Endpoint
        api_instance.zaehler()  # this invokes api_instance.zaehler.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.zaehler.callable or self.callable in this class
